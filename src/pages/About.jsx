...
export default function About() {
  return (
    <div className="w-full bg-[#101115] px-4 py-10 sm:px-8 md:py-14">
      <div className="mx-auto flex flex-col sm:flex-row w-full max-w-5xl bg-zinc-200 p-4 gap-4">

        <div className="flex flex-row sm:flex-col gap-3 sm:w-[25%] w-full bg-zinc-100 p-3">
          {leftImages.map((item, i) => (
            <Cards key={i} {...item} />
          ))}
        </div>

        <div className="flex flex-col justify-center gap-6 sm:w-[50%] w-full bg-zinc-100 p-3">
